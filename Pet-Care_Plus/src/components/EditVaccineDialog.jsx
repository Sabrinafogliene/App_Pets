...
const EditVaccineDialog = ({ open, onOpenChange, onVaccineUpdated, vaccine, className }) => {
  ...
  useEffect(() => {
    if (vaccine) {
      setFormData({
        ...
        next_dose: vaccine.next_dose ? new Date(vaccine.next_dose).toISOString().split('T')[0] : '',
