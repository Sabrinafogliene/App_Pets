...
const AgendaPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!form.paciente || !form.tipo || !form.data || !form.local) return;
    
    
    const novaConsulta = { ...form, id: Date.now() };
    setConsultas(prev => [...prev, novaConsulta]);

    
    setForm({ paciente: '', tipo: '', data: '', local: '' });
  };
  ...
  return (
    <DashboardLayout>
      <div className="p-8 max-w-3xl mx-auto">
        ...
        {/* Card para listar as consultas agendadas */}
        <Card>
          <CardHeader>
              ...
              <div className="space-y-4">
                {consultas.map(con => (
                  <div key={con.id} className="border rounded-lg p-4 bg-gray-50">
                    ...
                    <p><strong>Data:</strong> {new Date(con.data).toLocaleString('pt-BR')}</p>
